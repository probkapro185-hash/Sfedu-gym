...
//матрциа 4 на 4 создать использовать массив на раст, найти и вывести в матрице смежности одномерный массив чисел номера вершин 2 и 4
//найти пересечение множеств вершин
//теория графов
